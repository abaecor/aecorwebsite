...
<header>
            ...
            <ul>
                ...
                <li><a class="responsive_text" href="#help" title="help">How We Can Help</a></li>
                <li><a class="responsive_text" href="#about" title="about">About Us</a></li>
                <li><a class="responsive_text" href="#meettheteam" title="meettheteam">Meet The Team</a></li>
                <li><a class="responsive_text" href="#work" title="work">Work</a></li>
...
<article class="container">
    <div class="row">
        <div class="span12" id='sub_nav'>
            ...
            <div class='bottom'>
                <a class='btn' href='#help'> How We Can Help</a><br/>
...
<article class="container">
    ...
    <div class="span12">
                <h1 class="responsive_text">How We Can Help</span></h1>
...
<article class="container">
    <div class="row">
        <div class="span12">
            ...
            <div class="div2"></div>
            <div class="div3"></div>
            <div class="div4" onmouseout="document.getElementById('grp').src='images/group1.png';" onmouseover="document.getElementById('grp').src='images/group2.png'"></div>
            <div class="div5"></div>
            <div class="div6"></div>
        </div>
    ...
    <div class="row">
        <div class="span12">
            <div class="sub_header">
                <h1 class="responsive_text">About Us</h2>
                <h3>Kiss. Embrace. Love.</h3>
            </div>
    	</div>
	</div>
    ...
    <div class="row iconset">
        ...
        <div class="span4">
            ...
            <article class="content">
                ...
                <h4>Evolve</h4>
                <p>
                     No body is perfect. Tweak, test<br/> and improve. Learn from<br/> mistakes and strive for<br/> perfection. 
                </p>
            </article>
        </div>
    </div>	
...
<article class="container">
    <div class="row red_banner">
        <div class="span12">
            <div class="sub_header">
                <h1 class="responsive_text">Work</h2>
                <h3>It's not all about design and making your website look nice. Check out
...
<article class="container">
    ...
    <div class="row">
        <div class="span12 black_banner">
            <div class="sub_header">
            <h1 class="responsive_text">Contact Us</h2>
            <h3>A global presence. Our technical development is carried out in India,
                <br/>whilst our core design, client contact and project management is done in the UK.</h3>
            </div>
